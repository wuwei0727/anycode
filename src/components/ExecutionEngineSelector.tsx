        ...
        <div className="space-y-4 p-4">
          ...
          {value.engine === 'codex' && (
            <>
              ...
              {/* Model and Reasoning Mode Configuration - 只读显示 */}
              <div className="space-y-2">
                <Label className="text-sm font-medium">模型配置</Label>
                <div className="space-y-1 p-2 bg-muted/30 rounded-md">
                  <div className="text-xs text-muted-foreground">
                    模型: <span className="text-foreground">{value.codexModel || 'gpt-5.2'}</span>
                  </div>
                  <div className="text-xs text-muted-foreground">
                    推理模式: <span className="text-foreground">{value.codexReasoningMode || 'medium'}</span>
                  </div>
                </div>
