...
export interface CodexFileChangeItem {
  ...
  // Newer Codex CLI shape (supports multiple changes per item)
  changes?: Array<{
    path?: string;
    kind?: 'create' | 'update' | 'delete';
    // sometimes alternative field names may appear
    file_path?: string;
    change_type?: 'create' | 'update' | 'delete';
  }>;
  status: 'in_progress' | 'completed' | 'failed';
...
export interface CodexSession {
  ...
  /** 🆕 Last assistant message (AI response summary for search) */
